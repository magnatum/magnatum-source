...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "MAGNATUM OFFICIAL FAIR LAUNCH";
        ...
        assert(hashGenesisBlock ==       uint256("0x811033fc00054d6e535d5a63caff8ecd9209b9e50528a5a9091f680e86393395"));
        assert(genesis.hashMerkleRoot == uint256("0x410a2d4edfd596d5136fe66763672ce9c8ac78a84d9da6d89ef3041f954bb96a"));

        //MineGenesis(genesis);

        vSeeds.push_back(CDNSSeedData("104.40.154.163", "104.40.154.163"));
       ...
       // vSeeds.push_back(CDNSSeedData("122.129.64.14", "122.129.64.14"));
        ...
        nPOSStartBlock = nLastPOWBlock - 1;
    }
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("192.168.152.128", "192.168.152.128"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // magnatum test net start with T
