...
CBlock* CreateNewBlock(CReserveKey& reservekey, bool fProofOfStake, int64_t* pFees)
{
    ...
    unsigned int nRevardDiffSplit = pindexPrev->GetNextSplit();
    ...
    int64_t nFees = 0;
    {
        ...
        if (!fProofOfStake)
            pblock->vtx[0].vout[0].nValue = GetProofOfWorkReward(nFees, nRevardDiffSplit);
...
void FormatHashBuffers(CBlock* pblock, char* pmidstate, char* pdata, char* phash1)
{
    ...
    tmp.block.nRevardDiffSplit       = pblock->nRevardDiffSplit;
